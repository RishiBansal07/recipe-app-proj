...
//        );
    ...
    void fetchDetails() {
        ...
        //then
        List<Recipe> recipes = recipeService.findRecipes(recipeFetchRequestDTO);
    ...
    void insertDetails() {
        ...
        when(recipeRepository.save(recipeToSave)).thenReturn(recipeReturn);
        when(recipeService.saveRecipe(recipeInsertRequestDTO)).thenReturn(1L);
        assertEquals(1L, recipeService.saveRecipe(recipeInsertRequestDTO));
    }
    ...
    void modifyDetails() {
        ...
        assertEquals(1L, recipeService.updateRecipe(id, recipeUpdateRequestDTO));
    }
    ...
    void deleteDetails() {
        ...
        //then
        verify(recipeService, times(0)).deleteById(anyLong());
    }
