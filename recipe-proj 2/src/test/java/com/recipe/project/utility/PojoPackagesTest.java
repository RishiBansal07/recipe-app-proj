...
class PojoPackagesTest {
    private static final String POJO_PACKAGE_ENTITIES = "com.recipe.project.entities";
    private static final String POJO_PACKAGE_DTO = "com.recipe.project.datatransfer";
